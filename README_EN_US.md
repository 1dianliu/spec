...
Enter `/trigger tp` to choose another dimension, invalid in survival mode when clicked.Clicking in survival mode will prompt that it cannot be used  
...
Find the map folder in `.minecraft\saves`, You can also select the map in the game and click "Edit-Open World Folder" to enter  